...
const num1 = ref(pageStore.page1Inputs.num1)
const num2 = ref(pageStore.page1Inputs.num2)
...
watch([num1, num2], ([newNum1, newNum2]) => {
  pageStore.setPage1Inputs({ num1: newNum1, num2: newNum2 })
})

onMounted(() => {
  num1.value = pageStore.page1Inputs.num1
  num2.value = pageStore.page1Inputs.num2
})
</script>
<template>
